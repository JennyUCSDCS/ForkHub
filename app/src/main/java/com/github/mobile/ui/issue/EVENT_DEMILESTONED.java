...
public class EVENT_DEMILESTONED extends Event {
    public String Message(Resources resources, TimelineEvent event) {
        return String.format(resources.getString(R.string.issue_event_milestone_removed), "<b>" + event.milestone.title + "</b>");
    }
